const VERSION='mis-2027-offline-v11';
const STATIC_CACHE=`${VERSION}-static`;
const DATA_CACHE=`${VERSION}-data`;
const STUDY_CACHE=`${VERSION}-study`;
const STATIC=['/','/index.html','/styles.css?v=20260924f-kv-files','/app.js?v=20260924f-kv-files','/manifest.webmanifest?v=20260924f-kv-files','/favicon.svg?v=20260924f-kv-files','/mis-logo.png','/icon-192.png','/icon-512.png'];
